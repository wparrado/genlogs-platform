...
C4Container
    ...
    ContainerDb(db, "PostgreSQL", "PostgreSQL 15", "Stores carrier reference data, city entities, corridor statistics, and platform analytics data.")
...
C4Component
    ...
    ContainerDb_Ext(db, "PostgreSQL", "Carrier reference, city entities, corridor stats")
